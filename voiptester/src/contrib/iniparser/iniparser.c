...
static void strlwc(char * s)
{
    ...
    i=0 ;
    while (s[i]) {
        /*Modified by Huang Zhigeng. <*/
        /*Reason: Serveral function call strlwc to transfer capital to lowercase. But*/
        /*        we dont need this feature. Instead it will make action not readable.*/
        /*        So I remove the below statement.*/
